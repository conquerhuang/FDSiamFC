...
from siamfc.backbones import FDAlexNet_8l_lite
...
class TrackerFDSiamFC_8l_lite(Tracker):

    def __init__(self, net_path=None, name='SiamFC', squeeze_rate=None, **kwargs):
        super(TrackerFDSiamFC_8l_lite, self).__init__(name, True)
        ...
        # setup model
        self.net = Net(
            backbone=FDAlexNet_8l_lite(squeeze_rate=self.squeeze_rate),  # out_scale参数，起到对互相关结果加权的作用（互相关的值会很大）
